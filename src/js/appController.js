  ...
  function(ko, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider, OffcanvasUtils) {
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'us', detail: { label: 'Requirement', iconClass: 'oj-ux-ico-information-s' } },
        { path: 'about', detail: { label: 'OJET - Lesson 2', iconClass: 'oj-ux-ico-information-s' } },
        { path: 'Part03', detail: { label: 'OJET - Lesson 3', iconClass: 'oj-ux-ico-information-s' } }
      ];
      ...
      this.userLogin = ko.observable("pavan.maturi@oracle.com");
